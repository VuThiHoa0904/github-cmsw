...
_logger = logging.getLogger(__name__) # Tạo logger để Phân chia level cho các thông báo lỗi,
...
class Serializer(object):
    ...
    def build_flat_field(cls, rec, field_name):
        ...
        # print("++++++++++++++++++++++++++++++++++++++++++++++")
        # print(field_name)
        # print(rec.fields_get(field_name).get(field_name))
        # print("++++++++++++++++++++++++++++++++++++++++++++++")
        ...
        elif (isinstance(rec[field_name], list)):
            return {field_name: json.dumps(rec[field_name])}
        else:
...
class OdooAPI(http.Controller):
    @http.route('/auth/', type='json', auth='public',methods=["POST"], csrf=False, sitemap=False)
